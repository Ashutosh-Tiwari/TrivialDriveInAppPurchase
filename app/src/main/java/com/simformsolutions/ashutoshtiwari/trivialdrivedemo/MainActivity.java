...
package com.simformsolutions.ashutoshtiwari.trivialdrivedemo;
...
import com.simformsolutions.ashutoshtiwari.trivialdrivedemo.util.IabBroadcastReceiver;
import com.simformsolutions.ashutoshtiwari.trivialdrivedemo.util.IabBroadcastReceiver.IabBroadcastListener;
import com.simformsolutions.ashutoshtiwari.trivialdrivedemo.util.IabHelper;
import com.simformsolutions.ashutoshtiwari.trivialdrivedemo.util.IabHelper.IabAsyncInProgressException;
import com.simformsolutions.ashutoshtiwari.trivialdrivedemo.util.IabResult;
import com.simformsolutions.ashutoshtiwari.trivialdrivedemo.util.Inventory;
import com.simformsolutions.ashutoshtiwari.trivialdrivedemo.util.Purchase;
...
public class MainActivity extends Activity implements IabBroadcastListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        String base64EncodedPublicKey = BuildConfig.PUBLIC_KEY;

        // Some sanity checks to see if the developer (that's you!) really followed the
        // instructions to run this sample (don't put these checks on your app!)
/*
        if (base64EncodedPublicKey.contains(BuildConfig.PUBLIC_KEY)) {
